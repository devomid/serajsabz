...
const OurServicesShort = () => {
    ...
    return (
        <Grid container spacing={{ xs: 2, md: 3, lg: 5, xl: 8 }} columns={{ xs: 6, sm: 12, md: 12, lg: 16, xl: 18 }} sx={{ flexGrow: 1, alignItems: "center", padding: '0% 5vw 5% 5%' }}>
            <Grid md={4} lg={7} xl={8}>
                <Typography component={'div'} data-aos="zoom-in-down" data-aos-duration="1500" sx={{ color: 'white' }} level='h2'>
                    Our Services
                </Typography>

                <Typography component={'div'} data-aos="zoom-in-up" data-aos-duration="1500" sx={{ color: 'white' }} level='h3'>
                    We give you the solution!
                </Typography>
            </Grid>

            <Grid xs={5} sm={11} md={8} lg={9} xl={10}>
                <img style={{ objectFit: 'cover' }} data-aos="zoom-in-down" data-aos-duration="1500" onClick={() => {
                    navigate('/ourStory');
                    setIsHome(false);
                }} width={'100%'} height={'100%'} src='https://standarditservices.com/wp-content/uploads/2019/01/Our-Services.png' />

                <Typography maxHeight={'200px'} component={'div'} data-aos="zoom-in-up" data-aos-duration="1500" sx={{ width: '100%', color: 'white', truncate: true, overflow: 'hidden', textOverflow: 'ellipsis', textAlign: 'left', marginRight: 2, marginTop: 2 }}>
