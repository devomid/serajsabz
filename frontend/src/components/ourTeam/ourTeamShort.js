    ...
    return (
        <Box sx={{ width: '95%', height: '100%', display: 'flex', justifyContent: 'space-around', alignItems: 'center', padding: 5 }}>
            ...
            <Box sx={{ width: '50%', height: '40%' }}>
                <img width={'100%'} height={'75%'} src='https://media.istockphoto.com/id/1414896610/de/vektor/moderne-kreative-unserer-dienstleistungen-banner-template-mit-6-optionen-wie-visuelles.jpg?s=612x612&w=0&k=20&c=toV2gPtdjA_H2QoTpUvDRfTudqroAxO4zOizNxD4UQo=' />
