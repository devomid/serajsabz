...
const Home = () => {
        ...
        () => (
            {
                ...
                "background": {
                    ...
                    "image": "url('https://imageio.forbes.com/specials-images/imageserve/625d802e8acf449b7b041341//960x0.jpg?format=jpg&width=1440')",
                    "position": "50% 50%",
                    "repeat": "no-repeat",
                    "size": "cover",
                    "opacity": 1
    ...
    return (
        <Box sx={{ height: '80vh', display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'start', height: '10%', padding: 2, marginLeft: 5, width: '35%' }}>
                <Box>
            ...
            <Box sx={{ width: '65%', height: '80%', display: 'flex', gap: 3, padding: 1, marginRight: 4 }}>

                <Box sx={{ height: '95%', width: '50%', backgroundColor: 'rgba(255, 255, 255, 0.4)', borderRadius: 'xl', border: '1px solid white', padding: 3 }}>
                    <Typography sx={{ color: 'white' }} level='h6'>
                        We give you the solution!
                    </Typography>
                </Box>
                <Box sx={{ height: '95%', width: '50%', backgroundColor: 'rgba(255, 255, 255, 0.4)', borderRadius: 'xl', border: '1px solid white', padding: 3 }}>
